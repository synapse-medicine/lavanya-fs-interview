...
//             setMoleculeResults([]);
//             setIsSearching(false);
//             setInfoMessage('Allergy added successfully'); // Show success message
//           }
//         } catch (e) {
//           console.error('Error parsing response as JSON:', e, text);
//           setInfoMessage('Error adding allergy: Invalid response from server'); // Show error message
...
//               <li key={index} className="dropdown-item">
//                 {molecule.name}
//                 <button onClick={() => handleAddAllergy(molecule)} className="add-button">Add</button>
//               </li>
//             ))}
//           </ul>
//         )}
...
//best so far - all deatures working fine 
// import React, { useEffect, useState } from 'react';
// import { useParams } from 'react-router-dom';
// import ProfileItem from '../ProfileItem/ProfileItem';
// import './PatientProfile.css';
...
//             <li key={index}>
//               {molecule.name}
//               <button onClick={() => handleAddAllergy(molecule)}>Add</button>
//             </li>
//           ))}
//         </ul>
//       )}
...
//       .catch(error => {
//         console.error(error);
//         setErrorMessage({ title: 'Error fetching patient allergies', details: error.message });
//       });
//   }, [id]);
...
//       .then(data => {
//         if (data) {
//           setAllergies([...allergies, molecule]);
//         }
//         setMoleculeName('');
//         setMoleculeResults([]);
//         setIsSearching(false);
